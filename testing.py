...
# l1 = Layer(8, 6, activation=Layer.RELU)
# l2 = Layer(6, 4, activation=Layer.SOFTMAX)
# agent = Agent([l1, l2])
# poulation = Population(agent, population_size)


poulation = Population(file_name='snakes.npy')
poulation.evolution_settings(include_parents=include_parents, mutation_rate=rate, mutation_scale=scale, pool_size=pool_size, selection_method=method)
